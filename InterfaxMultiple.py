...
#----------------List BOX  -----------------------------------------------------   
        ...
        self.treeview = ttk.Treeview(master=self,columns=('col1','col2','col3'))
        self.treeview.heading('#0', text='ID')
        self.treeview.column('#0', width=70)
        self.treeview.heading('col1', text='Name')
        self.treeview.heading('col2', text='Email')
        self.treeview.heading('col3', text='Phone')
        self.treeview.grid(row = 4, column = 0, columnspan = 4, sticky="nsew")
...
# ------------- creación de la ventana grafica principal ------------------
...
#----------------Botones de acción -----------------------------------------------------
        self.ingresarButton = tk.Button(master=self,text="VENDEDORES",command=self.vendedores)
        self.ingresarButton.grid(row=0,column=0,padx=10,pady=10)
        self.actualizarButton = tk.Button(master=self,text="CLIENTES",command=self.clientes)
        self.actualizarButton.grid(row=1,column=0,padx=10,pady=10)
    
    def vendedores(self):
        ventanaVendedores = Vendedores()
        ventanaVendedores.mainloop()
    def clientes(self):
        ventanaVendedores = Vendedores()
        ventanaVendedores.mainloop()
